...
constexpr
std::intptr_t
sparse::details::constexpr_log2(std::intptr_t n) {
...
template <std::intptr_t BlockSize, typename _Ty >
_Ty*
sparse::DenseBlock< BlockSize, _Ty >::fetch(const std::intptr_t x,
          const std::intptr_t y) const {
...
template <std::intptr_t BlockSize, typename _Ty >
void
sparse::DenseBlock< BlockSize, _Ty >::write(const std::intptr_t x,
