...
OtherBlock&
sparse::PointerBlock<PointerGridSize, OtherBlock>::operator()(const std::intptr_t x, const std::intptr_t y) const {

}

template <std::intptr_t PointerGridSize, typename OtherBlock>
const OtherBlock&
sparse::PointerBlock<PointerGridSize, OtherBlock>::read(const std::intptr_t x, const std::intptr_t y) const {

}

template <std::intptr_t PointerGridSize, typename OtherBlock>
OtherBlock*
sparse::PointerBlock<PointerGridSize, OtherBlock>::fetch(const std::intptr_t x, const std::intptr_t y) const {

}

template <std::intptr_t PointerGridSize, typename OtherBlock>
void
sparse::PointerBlock<PointerGridSize, OtherBlock>::write(const std::intptr_t x, const std::intptr_t y, const OtherBlock& value) {
...
//                    auto& block =
//                              m_data[(x >> BlockShift) & GridMask][(y >> BlockShift) & GridMask];
...
//                    if (!block) {
//                              std::lock_guard<tbb::spin_mutex> _lck(
//                                        m_spinlock[(x >> BlockShift) & GridMask]
...
//                                        if (!block)
//                                                  continue; // empty, because of nullptr
//
