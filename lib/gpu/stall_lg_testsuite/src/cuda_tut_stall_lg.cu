...
__global__ void stall_lg_coalesced_32(int8_t *__restrict ptr1,
                                      int8_t *__restrict ptr2) {
  int id = threadIdx.x + blockIdx.x * blockDim.x;
  for (int i = 0; i < 2000; ++i) {
...
__global__ void stall_lg_coalesced_128(int8_t *__restrict ptr1,
                                       int8_t *__restrict ptr2) {
...
__global__ void stall_lg_coalesced_256_best(int8_t *__restrict ptr1,
                                            int8_t *__restrict ptr2) {
