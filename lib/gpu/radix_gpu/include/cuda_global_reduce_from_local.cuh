                    ...
                    namespace radix {
                              namespace details {
                                        ...
                                        namespace v2 {
                                                  ...
                                                  template <std::size_t BinSize>
                                                  __global__ void
                                                            kernel_global_reduce_from_local_v2(uint32_t* __restrict local,
                                                                      std::size_t local_length,
                                                                      uint32_t* __restrict global, std::size_t numBlocks) {
...
#pragma unroll 4
                                        ...
                                        namespace v3 {
                                                  ...
                                                  __global__ void
                                                  kernel_global_reduce_from_local_v3(
                                                            ...
                                                            */
                                                            ...
                                                            if (block_off >= out_real) return;

                                                            //ranging from 0-1023
                                                            uint32_t in_index = block_off * (BlockSize * BlockSize) + warp_id * BlockSize + lane;
...
#pragma unroll
                                                            ...
                                                            if (lane == 0) warp_sum[warp_id] = sum;
